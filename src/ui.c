...
letter_t small_font[ 128 ] = {
    ...
    {zero_width,        zero_height,        zero_bitmap       }, /* # 48 */
    {one_width,         one_height,         one_bitmap        },
    {two_width,         two_height,         two_bitmap        },
    {three_width,       three_height,       three_bitmap      },
    {four_width,        four_height,        four_bitmap       },
    {five_width,        five_height,        five_bitmap       },
    {six_width,         six_height,         six_bitmap        },
    {seven_width,       seven_height,       seven_bitmap      },
    {eight_width,       eight_height,       eight_bitmap      },
    {nine_width,        nine_height,        nine_bitmap       },
